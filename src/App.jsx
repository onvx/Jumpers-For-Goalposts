...
import { initLeagueRosters, normalizeRosters, sortStandings, collectSeasonEndAchievements, processSeasonSwaps, initLeague, initAILeague, buildSeasonCalendar, computeCalendarIndex, initCup, advanceCupRound, buildNextCupRound } from "./utils/league.js";
...
import { useMatchResult } from "./hooks/useMatchResult.js";
...
import { listProfiles, createProfile, readProfile, scanProfileSlots, getSaveKey, archiveCareerToMuseum, deleteMuseumEntry } from "./utils/profile.js";
    ...
    <div style={{
      ...
      {matchResult && (
        <MatchResultScreen
          ...
          slotAssignments={slotAssignments}
          startingXI={startingXI}
          onDone={(wasAlwaysFast, wasAlwaysNormal) => processMatchDone(matchResult, wasAlwaysFast, wasAlwaysNormal)}
        />
      )}
