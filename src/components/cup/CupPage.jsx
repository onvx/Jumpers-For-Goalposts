              ...
              <div style={{ marginTop: 24 }}>
                ...
                {cupStats.topScorers.map((s, i) => (
                  <div key={i} style={{
                    ...
                    <span style={{ color: i === 0 ? C.gold : C.slate }}>{i + 1}</span>
                    <span onClick={() => onPlayerClick?.(s.name, s.teamName)} style={{ color: C.text, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", cursor: "pointer", textDecoration: "underline", textDecorationStyle: "dotted", textDecorationColor: "#e2e8f044", textUnderlineOffset: 3 }}>{mob ? shortName(s.name) : s.name}</span>
